...
async function resolveFile(file, fileName) {
    ...
    if (file instanceof URL || typeof file === "string") {
        file = file.toString();
        fileName = fileName ?? `${file.match(exports.fileNamePattern)?.pop()}`;
        if (/^https?:\/\//.test(file))
        ...
        if ((0, node_fs_1.existsSync)(file))
            return streamToFile((0, node_fs_1.createReadStream)(file), fileName ?? "file");
        return new undici_1.File([file], "file");
    }
