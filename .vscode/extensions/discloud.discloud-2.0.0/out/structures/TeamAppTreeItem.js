...
const TeamAppChildTreeItem_1 = require("./TeamAppChildTreeItem");
class TeamAppTreeItem extends BaseTreeItem_1.default {
    data;
    iconName;
    appId;
    appType;
    ...
    _patch(data) {
        ...
        if ("container" in data)
            this.children.set("container", new TeamAppChildTreeItem_1.default({
        ...
        if ("memory" in data)
            this.children.set("memory", new TeamAppChildTreeItem_1.default({
        ...
        if ("cpu" in data)
            this.children.set("cpu", new TeamAppChildTreeItem_1.default({
        ...
        if ("ssd" in data)
            this.children.set("ssd", new TeamAppChildTreeItem_1.default({
        ...
        if ("netIO" in data)
            this.children.set("netIO", new TeamAppChildTreeItem_1.default({
        ...
        if ("last_restart" in data)
            this.children.set("last_restart", new TeamAppChildTreeItem_1.default({
        ...
        if ("perms" in data)
            this.children.set("perms", new TeamAppChildTreeItem_1.default({
                label: (0, l10n_1.t)("permissions"),
                children: data.perms?.map(perm => new vscode_1.TreeItem((0, l10n_1.t)(`permission.${perm}`))) ?? [],
                appId: this.appId,
...
exports.default = TeamAppTreeItem;
//# sourceMappingURL=TeamAppTreeItem.js.map